...
#ifndef LBCPP_NUMERICAL_LEARNING_LOSS_FUNCTION_LOG_BINOMIAL_MULTI_CLASS_H_
# define LBCPP_NUMERICAL_LEARNING_LOSS_FUNCTION_LOG_BINOMIAL_MULTI_CLASS_H_
...
#endif // !LBCPP_NUMERICAL_LEARNING_LOSS_FUNCTION_LOG_BINOMIAL_MULTI_CLASS_H_
