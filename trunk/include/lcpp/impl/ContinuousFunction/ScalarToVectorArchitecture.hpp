...
#ifndef LCPP_CORE_IMPL_FUNCTION_SCALAR_TO_VECTOR_ARCHITECTURE_H_
# define LCPP_CORE_IMPL_FUNCTION_SCALAR_TO_VECTOR_ARCHITECTURE_H_
...
#endif // !LCPP_CORE_IMPL_FUNCTION_SCALAR_TO_VECTOR_ARCHITECTURE_H_
