...
#ifndef LCPP_CORE_IMPL_FUNCTION_LOG_BINOMIAL_LOSS_H_
# define LCPP_CORE_IMPL_FUNCTION_LOG_BINOMIAL_LOSS_H_
...
#endif // !LCPP_CORE_IMPL_FUNCTION_LOG_BINOMIAL_LOSS_H_
