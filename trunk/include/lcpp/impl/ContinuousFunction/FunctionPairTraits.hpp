...
#ifndef LCPP_CORE_IMPL_FUNCTION_PAIR_TRAITS_H_
# define LCPP_CORE_IMPL_FUNCTION_PAIR_TRAITS_H_
...
//      std::cout << "Gradient of the multi-linear architecture: " << lcpp::toString(leftGradientWrtParameters) << std::endl;
...
#endif // !LCPP_CORE_IMPL_FUNCTION_PAIR_TRAITS_H_
