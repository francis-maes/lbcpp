...
#ifndef LCPP_STATIC_FEATURE_VISITOR_CREATE_SPARSE_VECTOR_HPP_
# define LCPP_STATIC_FEATURE_VISITOR_CREATE_SPARSE_VECTOR_HPP_
...
#endif // !LCPP_STATIC_FEATURE_VISITOR_CREATE_SPARSE_VECTOR_HPP_
