...
#ifndef LCPP_FEATURE_VISITOR_STATIC_TO_DYNAMIC_H_
# define LCPP_FEATURE_VISITOR_STATIC_TO_DYNAMIC_H_
...
class StaticToDynamicFeatureVisitorRef : public lcpp::FeatureVisitor
{
public:
...
inline void FeatureVisitor<ExactType>::featureCall(lcpp::FeatureDictionaryPtr dictionary, lcpp::FeatureGeneratorPtr featureGenerator)
{
  StaticToDynamicFeatureVisitorRef<ExactType> dynamicVisitor(_this());
  StaticallyAllocatedReferenceCountedObjectPtr<lcpp::FeatureVisitor> dynamicVisitorPtr(dynamicVisitor);
  {
...
#endif // !LCPP_FEATURE_VISITOR_STATIC_TO_DYNAMIC_H_
