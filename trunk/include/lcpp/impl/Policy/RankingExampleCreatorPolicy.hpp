...
#ifndef LCPP_CORE_IMPL_POLICY_RANKING_EXAMPLE_CREATOR_H_
# define LCPP_CORE_IMPL_POLICY_RANKING_EXAMPLE_CREATOR_H_
...
#endif // !LCPP_CORE_IMPL_POLICY_RANKING_EXAMPLE_CREATOR_H_
