...
#ifndef CRALGO_IMPL_FUNCTION_MOST_VIOLATED_PAIR_LOSS_H_
# define CRALGO_IMPL_FUNCTION_MOST_VIOLATED_PAIR_LOSS_H_
...
#endif // !CRALGO_IMPL_FUNCTION_MOST_VIOLATED_PAIR_LOSS_H_
