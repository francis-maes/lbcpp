...
#ifndef LBCPP_CORE_IMPL_POLICY_COMPUTE_STATISTICS_H_
# define LBCPP_CORE_IMPL_POLICY_COMPUTE_STATISTICS_H_
...
#endif // !LBCPP_CORE_IMPL_POLICY_COMPUTE_STATISTICS_H_
