...
#ifndef LBCPP_CORE_IMPL_VALUE_FUNCTION_CLASSIFIER_H_
# define LBCPP_CORE_IMPL_VALUE_FUNCTION_CLASSIFIER_H_
...
struct ClassifierScoresActionValue : public ClassifierBasedActionValueFunction<ClassifierScoresActionValue>
{
  ...
  void setChoose(ChoosePtr choose)
  {
    ...
    //std::cout << "SCORES = " << lbcpp::toString(scores) << std::endl;
    assert(scores);
  }
};
...
#endif // !LBCPP_CORE_IMPL_VALUE_FUNCTION_CLASSIFIER_H_
