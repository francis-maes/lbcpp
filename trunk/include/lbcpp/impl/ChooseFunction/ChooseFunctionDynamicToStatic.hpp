...
#ifndef LBCPP_CORE_IMPL_CHOOSE_FUNCTION_DYNAMIC_TO_STATIC_H_
# define LBCPP_CORE_IMPL_CHOOSE_FUNCTION_DYNAMIC_TO_STATIC_H_
...
#endif // !LBCPP_CORE_IMPL_CHOOSE_FUNCTION_DYNAMIC_TO_STATIC_H_
