...
#ifndef LBCPP_CORE_IMPL_CHOOSE_FUNCTION_STATIC_TO_DYNAMIC_H_
# define LBCPP_CORE_IMPL_CHOOSE_FUNCTION_STATIC_TO_DYNAMIC_H_
...
#endif // !LBCPP_CORE_IMPL_CHOOSE_FUNCTION_STATIC_TO_DYNAMIC_H_
