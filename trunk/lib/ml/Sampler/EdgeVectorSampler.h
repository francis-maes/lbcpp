...
public:
  ...
  virtual ObjectPtr sample(ExecutionContext& context) const
  {
    ...
    {
      DenseDoubleVectorPtr sampleLowerbound = domain->sampleUniformly(context.getRandomGenerator()).staticCast<DenseDoubleVector>();
      DenseDoubleVectorPtr sampleUpperbound = domain->sampleUniformly(context.getRandomGenerator()).staticCast<DenseDoubleVector>();
