...
int make_job(File* file) {
  ...
  String newLocation("NetworkTest/.WorkUnit/InProgress/");
...
void main_loop()
{
  ...
  File directory(config.project_path("NetworkTest/.WorkUnit/Waiting"));
...
void usage(char *name)
{
  fprintf(stderr, "This is the LBCpp work generator.\n"
          ...
          "- Runs as a daemon\n"
          "- Creates a job for each file (WU) found in NetworkTest/.WorkUnit/Waiting/\n\n"
          "Usage: %s [OPTION]...\n\n"
          "Options:\n"
