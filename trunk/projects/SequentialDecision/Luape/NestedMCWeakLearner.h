...
public:
  ...
  virtual LuapeNodePtr learn(ExecutionContext& context, const BoostingLearnerPtr& strongLearner, const IndexSetPtr& examples, bool verbose, double& weakObjective)
  {
