...
#ifndef LBCPP_CONTINUOUS_FUNCTION_LOG_BINOMIAL_LOSS_H_
# define LBCPP_CONTINUOUS_FUNCTION_LOG_BINOMIAL_LOSS_H_
...
#endif // !LBCPP_CONTINUOUS_FUNCTION_LOG_BINOMIAL_LOSS_H_
