...
% TODO état de l'art + d'autres ref
% TODO différencier état de l'art et contributions
\section{Introduction}
% TODO
...
\label{edageneral}
% TODO dire qu'on prend paramètres indépendants et dire que autre chose existe
...
% TODO variantes + complexes, UMDA, etc
% TODO relire les articles de wehenkel

% TODO image wikipedia
% TODO implémentation et/ou détail

% TODO : http://www.cleveralgorithms.com/nature-inspired/probabilistic/umda.html
% TODO : http://fr.wikipedia.org/wiki/Algorithme_à_estimation_de_distribution
...
\STATE send$(X)$
\ENDIF
\IF{assez de résultat disponibles}
...
\label{prototype}
% TODO 
% TODO peut supprimer pour remonter tout d'une section
...
Cette section a pour but de décrire le \textit{framework} d'optimisation qui a été développé. La section s'articule en deux parties bien distinctes: % TODO ref
\begin{itemize}
...
\label{frameworkintro}
% TODO dire que les diagrammes sont pas 100% fidèles (Ptr, const, &, * etc)
