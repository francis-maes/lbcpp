...
public:
  ...
  virtual ObjectPtr run(ExecutionContext& context)
  {
    ...
    SolverPtr sbSolver = batchSurrogateBasedSolver(samplerToVectorSampler(uniformSampler(), 20), createRegressionExtraTreeLearner(), ceSolver, scalarVectorVariableEncoder(), greedySelectionCriterion(), 5000);
