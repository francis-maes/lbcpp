...
namespace lbcpp
{
  ...
  extern Component* createComponentForVariable(ExecutionContext& context, const Variable& variable, const String& name = String::empty, bool topLevelComponent = false);
