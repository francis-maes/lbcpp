...
#ifndef LBCPP_CORE_IMPL_CONTINUOUS_FUNCTION_DYNAMIC_TO_STATIC_H_
# define LBCPP_CORE_IMPL_CONTINUOUS_FUNCTION_DYNAMIC_TO_STATIC_H_
...
#endif // !LBCPP_CORE_IMPL_CONTINUOUS_FUNCTION_DYNAMIC_TO_STATIC_H_
