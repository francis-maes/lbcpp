...
#ifndef LBCPP_CORE_IMPL_FUNCTION_LOG_BINOMIAL_LOSS_H_
# define LBCPP_CORE_IMPL_FUNCTION_LOG_BINOMIAL_LOSS_H_
...
#endif // !LBCPP_CORE_IMPL_FUNCTION_LOG_BINOMIAL_LOSS_H_
