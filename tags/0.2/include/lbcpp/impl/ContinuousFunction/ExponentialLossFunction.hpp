...
#ifndef LBCPP_CORE_IMPL_FUNCTION_EXPONENTIAL_LOSS_H_
# define LBCPP_CORE_IMPL_FUNCTION_EXPONENTIAL_LOSS_H_
...
#endif // !LBCPP_CORE_IMPL_FUNCTION_EXPONENTIAL_LOSS_H_
