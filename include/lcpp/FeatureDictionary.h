...
#ifndef LCPP_FEATURE_DICTIONARY_H_
# define LCPP_FEATURE_DICTIONARY_H_
...
public:
  ...
  */
  ...
  {
    return "Features: " + lcpp::toString(*featuresDictionary) + "\n"
           "Scopes: " + lcpp::toString(*scopesDictionary) + "\n";
  }
...
#endif // !LCPP_STRING_DICTIONARY_H_
