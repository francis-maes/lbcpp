...
#ifndef LCPP_RANDOM_VARIABLE_H_
# define LCPP_RANDOM_VARIABLE_H_
...
public:
  ...
  virtual std::string toString() const
    {return ScalarRandomVariableMean::toString() + " +/- " + lcpp::toString(getStandardDeviation());}
 ...
 public:
  ...
  virtual std::string toString() const
  {
    return ScalarRandomVariableMeanAndVariance::toString() + " [" +
      lcpp::toString(min) + " - " + lcpp::toString(max) + "]";
  }
