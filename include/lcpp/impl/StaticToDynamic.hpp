...
#ifndef LCPP_CORE_IMPL_STATIC_TO_DYNAMIC_H_
# define LCPP_CORE_IMPL_STATIC_TO_DYNAMIC_H_
...
#define STATIC_TO_DYNAMIC_CLASS(Class, BaseClass) \
  STATIC_TO_DYNAMIC_BEGIN_0_1(Class, BaseClass, lcpp::Class)
...
#endif // !LCPP_CORE_IMPL_STATIC_TO_DYNAMIC_H_
