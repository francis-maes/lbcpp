...
#ifndef LCPP_CORE_IMPL_FUNCTION_SCALAR_VECTOR_FUNCTIONS_HPP_
# define LCPP_CORE_IMPL_FUNCTION_SCALAR_VECTOR_FUNCTIONS_HPP_
...
#endif // !LCPP_CORE_IMPL_FUNCTION_SCALAR_VECTOR_FUNCTIONS_HPP_
