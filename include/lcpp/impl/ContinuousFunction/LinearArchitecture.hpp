...
#ifndef LCPP_CORE_IMPL_FUNCTION_LINEAR_ARCHITECTURE_H_
# define LCPP_CORE_IMPL_FUNCTION_LINEAR_ARCHITECTURE_H_
...
#endif // !LCPP_CORE_IMPL_FUNCTION_LINEAR_ARCHITECTURE_H_
