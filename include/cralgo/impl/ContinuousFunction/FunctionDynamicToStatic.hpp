...
#ifndef CRALGO_IMPL_CONTINUOUS_FUNCTION_DYNAMIC_TO_STATIC_H_
# define CRALGO_IMPL_CONTINUOUS_FUNCTION_DYNAMIC_TO_STATIC_H_
...
#endif // !CRALGO_IMPL_CONTINUOUS_FUNCTION_DYNAMIC_TO_STATIC_H_
