...
#ifndef LBCPP_CORE_IMPL_FUNCTION_MOST_VIOLATED_PAIR_LOSS_H_
# define LBCPP_CORE_IMPL_FUNCTION_MOST_VIOLATED_PAIR_LOSS_H_
...
#endif // !LBCPP_CORE_IMPL_FUNCTION_MOST_VIOLATED_PAIR_LOSS_H_
